...
//        [deleleBtn setTitle:@"删除" forState:UIControlStateNormal];
        //修改删除图标
        [deleleBtn setImage:[UIImage imageNamed:@"删除.png"] forState:UIControlStateNormal];
...
- (void)show{
    ...
    if (animation) {
        [[[[UIApplication sharedApplication] windows] lastObject].rootViewController presentViewController:self animated:animation completion:nil];
//        [UIApplication sharedApplication].windows.lastObject showview
    }else{
