...
//    return [self.image sizeThatFits:self.bounds.size];
    return [self.image sizeThatFits:[UIApplication sharedApplication].keyWindow.bounds.size];
}
...
//    NSLog(@"self.bounds=%@",NSStringFromCGSize(self.bounds.size));
...
//    NSLog(@"self.bounds=%@",NSStringFromCGSize(self.bounds.size));
    ...
    NSLog(@"self.bounds=%@",NSStringFromCGSize(iv.frame.size));
...
//        self.containerView.frame = CGRectMake(0, 110, 300, 600);
        imageView.bounds = CGRectMake(0, 0, imageSize.width, imageSize.height);
//        imageView.bounds = [UIApplication sharedApplication].keyWindow.bounds;
