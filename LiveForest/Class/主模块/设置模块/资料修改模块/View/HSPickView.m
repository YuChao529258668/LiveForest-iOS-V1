...
-(UIPickerView *)pickView
{
    if (_pickView == nil) {
        ...
        _pickView.frame = CGRectMake(0, pickViewY,self.bounds.size.width,pickViewH);
...
-(void)doneClickSave
{
    ...
    if(self.areaLevel == AreaLevelDistrict)
    {
        ...
        if ([city rangeOfString:province].length > 0) {
            ...
            self.areaID = [dataFormatHandle areaIDFormatHandleWithProvince:province City:city District:distirct];
        }else{
    ...
    else//2级联动
    {
        ...
        if ([city rangeOfString:province].length > 0) {
            ...
            self.areaID = [dataFormatHandle areaIDFormatHandleWithProvince:province City:city District:nil];
        }else{
